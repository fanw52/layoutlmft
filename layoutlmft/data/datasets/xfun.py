...
class XFUN(datasets.GeneratorBasedBuilder):
    ...
    tokenizer = AutoTokenizer.from_pretrained("/data/wufan/data/layoutlm/model/layoutxlm-base")

    # /data/wufan/algos/data/transformers_data/XFUN/model/layoutxlm-base
    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            datasets.SplitGenerator(name=datasets.Split.TRAIN,
                                    gen_kwargs={
                                        # "filepaths": ["/data/wufan/data/layoutlm/data/XFUN/zh.train.json"]
                                        "filepaths": [data_args.train_file]
                                    },
                                    ),
            datasets.SplitGenerator(
                name=datasets.Split.VALIDATION,
                gen_kwargs={
                    # "filepaths": ["/data/wufan/data/layoutlm/data/XFUN/zh.val.json"]
                    "filepaths": [data_args.validation_file]
                },
            ),
